#!/bin/bash
#SBATCH --job-name=exp2%j        # name of job
...
file_paths_args="--exp_path / --model_weights_path / --annot_fname bboxes_16_cases.json"
...
python -u training.py ${file_paths_args} ${training_args}
